...
<img src="/static/img/github-sign-up.png" width="800">
 ...
 2. __[Fork](https://help.github.com/fork-a-repo/)__ the [smtpapi-python](https://github.com/sendgrid/smtpapi-python) repository:
 ...
 3. __Clone__  your fork via the following commands:  
  ...
  ```   
    ...
    git clone https://github.com/your_username/smtpapi-python
